...
def main():
    ...
    ## Insertamos nuestro modelo entrenado aquí desde local
    ...
    mp4_bitrate = '5M'
    random_seed = 42
    mp4_file = 'results/ideaslocas-random_grid_%s.mp4' % random_seed
    minibatch_size = 8
    ...
    def make_frame(t):
        ...
        images = Gs.run(latents, None, truncation_psi=0.9,
    ...
    # Generate video.
    import moviepy.editor
    mp4_file = 'results/ideaslocas-interpolate.mp4'
    mp4_codec = 'libx264'
    mp4_bitrate = '5M'
    ...
    def make_frame(t):
        ...
        col_dlatents[:, 2] = src_dlatents[frame_idx, 2]
        col_images = Gs.components.synthesis.run(col_dlatents, randomize_noise=False, **synthesis_kwargs)
        return col_images[0]

    # Generate video.
    import moviepy.editor
    mp4_file = 'results/ideaslocas-fine_%s.mp4' % (random_seed)
    mp4_codec = 'libx264'
    mp4_bitrate = '5M'
